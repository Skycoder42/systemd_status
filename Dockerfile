...
FROM busybox:latest as download_app
ARG APP_VERSION
WORKDIR /web

ADD https://github.com/Skycoder42/systemd_status/releases/download/app%2Fv${APP_VERSION}/Systemd.Status.Web.tar.xz /src/
...
COPY --from=download_app /web/ /app/web/app/
WORKDIR /app
