...
## [0.4.3] - 2026-07-25
### Changed
- Updated embedded web client to 0.4.2
...
## [0.4.1] - 2025-04-30
### Added
- Added Ubuntu Noble (24.04) release builds

## [0.4.0] - 2025-04-30
### Added
- Add system endpoint to allow rebooting
  - requires explicit `canReboot: true` permission on the user

### Changed
- Updated embedded web client to 0.4.0

## [0.3.3] - 2025-04-29
### Changed
- Updated dependencies
- Updated min dart sdk to 3.7.0
- Updated embedded web client to 0.3.3
...
[0.4.3]: https://github.com/Skycoder42/systemd_status/compare/server%2Fv0.4.2...v0.4.3
[0.4.2]: https://github.com/Skycoder42/systemd_status/compare/server%2Fv0.4.1...v0.4.2
[0.4.1]: https://github.com/Skycoder42/systemd_status/compare/server%2Fv0.4.0...v0.4.1
[0.4.0]: https://github.com/Skycoder42/systemd_status/compare/server%2Fv0.3.3...v0.4.0
[0.3.3]: https://github.com/Skycoder42/systemd_status/compare/server%2Fv0.3.2...v0.3.3
