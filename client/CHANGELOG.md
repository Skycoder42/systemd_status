...
## [0.4.2] - 2026-07-25
### Fixed
- Fixed initialization with riverpod due to changed APIs
...
## [0.4.0] - 2025-04-30
### Added
- Added reboot context menu action to reboot the server
  - Requires special permission for the user that must be set on the server

### Fixed
- Ensure autofill works for login page
- Downgrade `file_picker` because of Android bug (See https://github.com/miguelpruivo/flutter\_file\_picker/issues/1769)
...
[0.4.3]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.4.2...v0.4.3
[0.4.2]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.4.1...v0.4.2
[0.4.1]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.4.0...v0.4.1
[0.4.0]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.3.3...v0.4.0
[0.3.3]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.3.2...v0.3.3
[0.3.2]: https://github.com/Skycoder42/systemd_status/compare/client%2Fv0.3.1...v0.3.2
